...
router.get('/admin/monthly-analytics',authMiddleware, dashboardController.get_admin_monthly_analytics)
router.get('/seller/get-dashboard-data',authMiddleware, dashboardController.get_seller_dashboard_data) 
router.get('/seller/monthly-analytics',authMiddleware, dashboardController.get_seller_monthly_analytics) 
...
router.post('/seller/review/reply', authMiddleware, dashboardController.reply_review)
